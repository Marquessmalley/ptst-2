...
const Menu = () => {
  return (
    <Navbar className="w-full">
      ...
      <NavbarContent className="flex w-full justify-between px-6">
        <div className="flex gap-4"></div>
        <div className="flex gap-4">
          <NavbarItem className="lg:flex">
            <div className="rounded-3xl bg-gradient-to-b from-blue-600 to-orange-300 p-px">
              <div className="rounded-[calc(1.5rem-1px)] bg-gray-100 p-2 transition duration-200 hover:bg-gray-200">
                <Link
                  href="#"
