    ...
    <>
      ...
      <div className="shrink-0 border-t border-sky-100 bg-white/80 px-3 py-3 backdrop-blur-sm sm:px-4">
        ...
        >
          <PromptInputBody>
            <textarea
              className="max-h-32 min-h-[48px] flex-1 resize-none border-0 bg-transparent px-4 py-3.5 text-base placeholder:text-slate-400 focus:outline-none focus:ring-0 sm:text-sm"
